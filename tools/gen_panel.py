...
:root {
  ...
  /* Summit-mode wash. Desaturated on purpose: operators sit in front of this
     all day, and a saturated red would both fatigue them and compete with the
     Not Ready pills, which is the one thing that must stay loudest. Light
     enough that body text keeps well over 7:1 contrast. */
  --bg-summit: #f2dede;
  --edge-summit: #b3403f;
}
